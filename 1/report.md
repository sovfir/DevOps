...
- VIM Для выхода и сохранения - ESC потом в командной строке набрать :wq

![time](img/15.png)

- NANO CTR+X для выхода и подтвердить сохранение файла
...
- общее количество процессов - 161
- загрузку cpu - 0.0
- загрузку памяти - MiB Mem - 3907
- pid процесса занимающего больше всего памяти - pid 1 systemd - 0.3
- pid процесса, занимающего больше всего процессорного времени - pid 52 - root
...
- df -h, --human-readable
Отобразит размер в человеко-читаемом формате, размерностью 1024, добавив названия единиц
![time](img/31.png)
